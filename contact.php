  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="dashboard.php" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">MoviesDekho</h1>
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="logout.php"><span>Log out</span></a>
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4" data-aos="fade-up" data-aos-delay="200">
          <img style="border:0; width: 100%; height: 270px;" src="assets/img/post-slide-1.jpg">
        </div><!-- End Google Maps -->
